...
// Vendored from https://github.com/mitsuhiko/agent-stuff/blob/main/extensions/todos.ts
// Original project: agent-stuff by Armin Ronacher and contributors.
// Modifications: vendored into Patchmill for bundled Pi todo support.
