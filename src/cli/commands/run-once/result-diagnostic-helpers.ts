...
const LABELS: Record<string, string> = {
  ...
  forgeMergeOid: "Forge merge OID",
  fetchedBaseOid: "Fetched base OID",
  evidenceFailure: "Evidence failure",
  artifactKinds: "Artifact kinds",
  expectedPaths: "Expected paths",
  observedCandidates: "Observed candidates",
  recordedHeadOid: "Recorded head OID",
  hostHeadOid: "Host head OID",
  fetchedHeadOid: "Fetched head OID",
  remoteHeadOid: "Remote head OID",
  adoptionFailure: "Adoption failure",
  artifactPaths: "Artifact paths",
  unexpectedPaths: "Unexpected paths",
